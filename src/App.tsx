...
import DeliveryLogoFullSrc from "./assets/DeliveryLogoFull.svg";
import DeliveryLogoSmallSrc from "./assets/DeliveryLogoSmall.svg";
import JustBretheLogoSrc from "./assets/JustBretheLogo.svg";
import MapComponent from "./MapComponent"; // <--- Import your separate component

// Declare the SVG modules to fix TypeScript errors
declare module "*.svg" {
